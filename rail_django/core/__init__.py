...
_LAZY_EXPORTS = {
    ...
    "GraphQLAutoError": ("rail_django.core.errors", "GraphQLAutoError"),
    "ValidationError": ("rail_django.core.errors", "ValidationError"),
    "AuthenticationError": ("rail_django.core.errors", "AuthenticationError"),
    "PermissionError": ("rail_django.core.errors", "PermissionError"),
    "ResourceNotFoundError": (
        "rail_django.core.errors",
        "ResourceNotFoundError",
    ),
    "SecurityError": ("rail_django.core.errors", "SecurityError"),
    "RateLimitError": ("rail_django.core.errors", "RateLimitError"),
    "QueryComplexityError": ("rail_django.core.errors", "QueryComplexityError"),
    "QueryDepthError": ("rail_django.core.errors", "QueryDepthError"),
    "FileUploadError": ("rail_django.core.errors", "FileUploadError"),
    "ErrorCode": ("rail_django.core.errors", "ErrorCode"),
    "ErrorHandler": ("rail_django.core.errors", "ErrorHandler"),
    "error_handler": ("rail_django.core.errors", "error_handler"),
    "handle_graphql_error": ("rail_django.core.errors", "handle_graphql_error"),
