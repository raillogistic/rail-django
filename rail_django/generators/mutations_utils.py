...
def validate_and_normalize_pk(
    ...
    """
    from .mutations_exceptions import InvalidIdFormatError
...
def resolve_fk_id(
    ...
    """
    from .mutations_exceptions import RelatedObjectNotFoundError
...
def check_bulk_size_limit(
    ...
    """
    from .mutations_exceptions import BulkSizeError
...
def check_nested_depth(
    ...
    """
    from .mutations_exceptions import NestedDepthError
