...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "rail_django_import_batch", "ordering": ["-created_at"]},
        ),
        migrations.CreateModel(
            name="ImportRow",
            fields=[
            ...
            options={"db_table": "rail_django_import_row", "ordering": ["row_number"]},
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={"db_table": "rail_django_import_issue", "ordering": ["row_number", "created_at"]},
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["app_label", "model_name"], name="rail_django_imp_app_7de6cc_idx"),
        ),
        migrations.AddIndex(
            model_name="importbatch",
            index=models.Index(fields=["status", "created_at"], name="rail_django_imp_sta_24bd95_idx"),
        ),
        migrations.AddIndex(
            model_name="importbatch",
            index=models.Index(fields=["uploaded_by_user_id", "created_at"], name="rail_django_imp_upl_9c2f40_idx"),
        ),
        migrations.AddIndex(
            model_name="importrow",
            index=models.Index(fields=["batch", "status"], name="rail_django_imp_bat_9dc532_idx"),
        ),
        migrations.AddIndex(
            model_name="importrow",
            index=models.Index(fields=["batch", "matching_key"], name="rail_django_imp_bat_58c822_idx"),
        ),
        migrations.AddIndex(
            model_name="importissue",
            index=models.Index(fields=["batch", "severity"], name="rail_django_imp_bat_7aca6c_idx"),
        ),
        migrations.AddIndex(
            model_name="importissue",
            index=models.Index(fields=["batch", "stage"], name="rail_django_imp_bat_8d7f12_idx"),
        ),
        migrations.AddIndex(
            model_name="importissue",
            index=models.Index(fields=["batch", "row_number"], name="rail_django_imp_bat_12de94_idx"),
        ),
        migrations.AddIndex(
            model_name="importsimulationsnapshot",
            index=models.Index(fields=["batch", "executed_at"], name="rail_django_imp_bat_4d7277_idx"),
        ),
    ]
